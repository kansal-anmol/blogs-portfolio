...
export const USER: User = {
	...
	shortIntro:
		'Hello! I am Anmol Kansal, a Senior Frontend Engineer @ D.E. Shaw India. I specialize in React, TypeScript, and state-of-the-art web architectures. I design scalable frontend infrastructures and bring visual experiences to life.',
	bio: 'I have more than 3.5 years of industry experience developing scalable web interfaces. Currently a Senior Member, Tech at D.E. Shaw India. Dedicated to clean coding, performant bundle loading, and highly optimized animation layers.',
	capabilities: [
		{
			id: 'frontend',
			label: 'Frontend',
			values: ['React', 'TypeScript', 'Next.js', 'Redux', 'Chakra UI', 'GraphQL', 'Tailwind CSS', 'HTML5', 'CSS3'],
		},
		{
			id: 'backend',
			label: 'Backend',
